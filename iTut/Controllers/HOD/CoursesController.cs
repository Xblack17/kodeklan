...
namespace iTut.Controllers.HOD
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Code,Theory,Mcq,Practical,Total,ClassNameId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Code,Theory,Mcq,Practical,Total,ClassNameId")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
